...
const Suppliers: React.FC = () => {
    ...
    const endpoint = 'http://localhost/pos-endpoint/addsupplier.php';
        ...
        <IonContent className={style.container}>
            <div className={style.topic}>
                <div className={style.employee}>
                    <div className={style.new}>New Supplier</div>
                    <div className={style.createnew}>Add new supplier</div>
                </div>
                <div>
                    <IonButton className={style.employeebut} routerLink="/supplierlist"> <IonIcon icon={arrowBack} /> Suppliers List</IonButton>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit}>
                    <div className={style.cont}>
                        ...
                        <div className={style.line}>
                            ...
                            <div className={style.inputs}>
                                <IonButton className={style.button} type="submit"> <IonIcon icon={addCircleSharp} /> Add Supplier</IonButton>
                            </div>
                        </div>
                    </div>
                    <div>
